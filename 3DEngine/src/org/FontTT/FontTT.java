...
import org.textures.TextureLoader;
...
public class FontTT {
	 ...
	 * 
	 */
	public void drawText(String whatchars, float size, float x, float y, float z, Color4f yellow, float rotxpass, float rotypass, float rotzpass, boolean centered) {
		...
		for (int i=0; i < whatchars.length(); i++) {
			...
			drawtexture(charactersp[k],fontsizeratio,totalwidth, 0, yellow, rotxpass, rotypass, rotzpass);
	...
	public void drawText(String whatchars, int size, int x, int y, int z, Color4f color, int rotxpass, int rotypass, int rotzpass, boolean centered) {
		float fontsizeratio = size/(float)fontsize;
